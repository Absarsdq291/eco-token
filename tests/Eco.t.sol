...
contract EcoTest is Test {
    ...
    function testSwapExactTokensForTokens() public {
        ...
        router.swapExactTokensForTokens(1 ether, 0, path, user, block.timestamp);
        ...
        vm.expectRevert();
        router.swapExactTokensForTokens(ecoAfter / 2, 0, path, user, block.timestamp);
    ...
    function testSwapExactTokensForTokensSupportingFeeOnTransferTokens() public {
        ...
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(2 ether, 0, path, user, block.timestamp);
    ...
    function testSwapTokensForExactTokensSupportingFeeOnTransferTokens() public {
        ...
        router.swapExactTokensForTokensSupportingFeeOnTransferTokens(wethToSpend, 0, path, user, block.timestamp);
    ...
    function _addLiquidity(address provider, uint256 ecoAmount, uint256 wethAmount) private {
        ...
        router.addLiquidity(address(eco), address(weth), ecoAmount, wethAmount, 0, 0, provider, block.timestamp);
    ...
    function _removeLiquidity(
        address provider,
        uint256 liquidity
    ) private returns (uint256 ecoAmount, uint256 wethAmount) {
        vm.startPrank(provider);
